      ...
      <Link to={`/product/${product.id}`} className="block">
        ...
        <div className="p-3 sm:p-4">
          ...
          <div className="mt-auto">
            <div className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white px-3 py-2.5 sm:px-4 sm:py-3 rounded-xl font-bold hover:shadow-lg hover:scale-[1.02] active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 text-xs sm:text-sm">
